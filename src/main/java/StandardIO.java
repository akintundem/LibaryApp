...
public class StandardIO implements Runnable, FrameworkUserInterface{

    BufferedReader console = null;
    TimeServerUserCommandHandler myUserCommandHandler;
    ...
    public void setUserCommandHandler(TimeServerUserCommandHandler myUserCommandHandler) {
